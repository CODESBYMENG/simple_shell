#include "shell.h"
/**
 * is_exist - Check the existence of the file.
 * @path_f: The file's path.
 *
 * Return: Always the exit code 127.
 */
...
/**
 * cmd_process - Processes the command.
 * @path_f: The file's path.
 * @last_cmd_status: The value of the last executed cmd.
 *
 * Return: The last cmd's valur or 127 If it fails.
 */
