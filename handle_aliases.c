...
* @cmd_args: The command line args.
* @start_of_args: The fisrt ârt of the cmd_args.
*
* Return: 0 or -1
*/
...
/**
* put_alias - Sets the alias.
* @name_al: The aliase's name.
...
/**
* al_print - Prints the alias.
* @alias: The alias's ptr.
*/
void al_print(alias_t *alias)
{
	char *str_al;
...
/**
* substitute_alias - Replaces the args with aliases
* @cmd_args: Array of pointers the the args.
*
* Return: A pointer to the pointer of array of args.
*/
