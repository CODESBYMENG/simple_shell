...
/**
 * fetch_cmd - Fetchs a command line from the end user.
 * @cmd_line: The buffer to store the cmd line.
 * @last_cmd_status: A pointer to the returned.
 * value of the last executed command.
 *
 * Return: The stored command or NULL.
 */
 ...
 * @start_of_args: Pointer to the start of cmd_args.
 * @last_cmd_status: The return value of the parent process.
 *
 * Return: Value returned from the last executed command.
 */
...
/**
 * cmd_run - Invoke the command.
 * @cmd_args: Array of args.
 * @start_of_args: Pointer to the start of cmd_args.
 * @last_cmd_status: The return value of the parent process.
 *
 * Return: Value of the last exec cmd.
 */
...
/**
 * process_args - Fetch and invoke the execution of a command.
 * @last_cmd_status: Value returned from the parent process.
 *
 * Return: The exit value of the last executed command or EOF.
 */
 ...
 * @cmd_args: A pointer to the parsed commands
 *
